 ...
 *
 * Note: iPadOS 13+ reports itself as a Mac, so it is detected via MacIntel + touch
 * points, not the "iPad" UA string alone. Kept separate from the iPhone build so
 * the two can be tuned independently. Desktop/Android use art-wall.js untouched.
 */
(function () {
